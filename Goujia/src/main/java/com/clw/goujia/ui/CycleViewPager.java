...
import com.clw.goujia.bean.ADInfo;
...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
  ...
  private RelativeLayout numIndicatorLayout; // 数字指示器
  private TextView tv_pager; // 显示
  ...
  private boolean isShow = false; // 是否显示圆点指示器
  private boolean isShowPager = false; // 是否显示页码
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    numIndicatorLayout = (RelativeLayout) view.findViewById(R.id.layout_viewpager_indicator_num);
    tv_pager = (TextView) view.findViewById(R.id.tv_pager);
    tv_total_pager = (TextView) view.findViewById(R.id.tv_total_pager);
  ...
  public void setData(List<View> views, int[] list, ImageCycleViewListener listener) {
   ...
   *          默认显示位置
   */
  public void setData(List<View> views, int[] list, ImageCycleViewListener listener, int showPosition) {
   ...
   * @param isShowPager
   * */
  public void setShowPager(boolean isShowPager) {
    this.isShowPager = isShowPager;
    if (isShowPager) {
      numIndicatorLayout.setVisibility(View.VISIBLE);
    } else {
      numIndicatorLayout.setVisibility(View.GONE);
    }
  }
      ...
      if (mImageCycleViewListener != null) {
        v.setOnClickListener(new OnClickListener() {
          ...
          public void onClick(View v) {
            mImageCycleViewListener.onImageClick(infos[currentPosition - 1], currentPosition, v);
          }
        });
      }
      container.addView(v);
  ...
  public void onPageSelected(int arg0) {
    ...
    tv_pager.setText(String.valueOf(currentPosition )+"/"+infos.length);
    /* 当前图片链接 */
    // mSharePicUrl = mItemCases.get(arg0).getPicurl();
  }
  ...
  private void setIndicator(int selectedPosition) {
    for (int i = 0; i < indicators.length; i++) {
      indicators[i].setBackgroundResource(R.drawable.point);
    }
    if (indicators.length > selectedPosition) {
      indicators[selectedPosition].setBackgroundResource(R.drawable.point_red);
    }
  }
  ...
  public static interface ImageCycleViewListener {
     ...
     * @param imageView
     */
    public void onImageClick(int info, int postion, View imageView);
  }
}